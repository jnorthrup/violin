...
/**
 * This file defines extension functions of [Stream] that transforms the stream into another
 * stream. The new stream is layered in front of the old stream: it pulls from the old stream in
