...
class TestCompat {
    ...
    /**  */
    @org.junit.Test fun Iterator_stream() = testStream { it.iterator().toStream() }


    /**  */
    @org.junit.Test fun Stream_stream() = testStream { java.util.stream.Stream.of(*it).toStream() }


    /**  */
    @org.junit.Test fun Sequence_stream() = testStream { sequenceOf(*it).toStream() }


    /**  */
    @org.junit.Test fun Array_stream() = testStream { it.toStream() }
